...
describe RVM do
  ...
  context "installed?" do
    ...
    it "prepares a gemset with bundler" do
      Environment.should_receive(:system).with('source home/.rvm/scripts/rvm && rvm use --create project@global && (gem list | grep bundler) || gem install bundler')
    ...
    it "generates an 'rvm use' script" do
      RVM.use_script('ruby', 'a_gemset').should == 'source home/.rvm/scripts/rvm && rvm use --create ruby@a_gemset'
    end
  end
